...
public class ArticleController {
	...
	@GetMapping(value = "/article/search/keyword/{keyword}", produces = { "application/json", "application/xml" })
	...
	@GetMapping(value = "/article/search/date/{date}", produces = { "application/json", "application/xml" })
